...
const user_create_dto_1 = require("./model/user-create.dto");
...
let UserController = class UserController {
    ...
    async create(body) {
        ...
        return this.userService.create(Object.assign(Object.assign({}, data), { password, role_id: { id: role_id } }));
    }
    async get(id) {
    ...
    async update(id, body) {
        const { role_id } = body, data = __rest(body, ["role_id"]);
        await this.userService.update(id, Object.assign(Object.assign({}, data), { role_id: { id: role_id } }));
        return this.userService.findOne({ id });
    }
    async delete(id) {
